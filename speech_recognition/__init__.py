...
class Recognizer(AudioSource):
    ...
    def recognize_bing(self, audio_data, key, language="en-US", show_all=False):
        ...
        if expire_time is None or monotonic() > expire_time:  # caching not enabled, first credential request, or the access token from the previous one expired
            ...
            credential_url = "https://westus2.api.cognitive.microsoft.com/sts/v1.0/issueToken"
        ...
        url = "https://westus2.stt.speech.microsoft.com/speech/recognition/conversation/cognitiveservices/v1?{}".format(urlencode({
            "language": language,
            "locale": language,
